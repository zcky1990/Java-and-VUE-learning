            ...
            <v-container>
                <div ref="formContainer" class="form-container">
                    ...
                    <v-form ref="form" v-model="valid" width="300">
                        ...
                        <v-text-field v-model="data.level" :rules="Rules1" label="Level" required outline type="number" flat color="rgb(0, 209, 178)"></v-text-field>
                        <v-text-field v-model="data.description" :rules="Rules2" label="Desrciption" required outline flat color="rgb(0, 209, 178)"></v-text-field>
...
export default {
    ...
    data() {
        return {
            ...
            dataTableList: [],
            status: [true, false],
            Rules1: [v => !!v || "Level is required"],
            Rules2: [v => !!v || "Description is required"]
        };
    },
    created() {
        this.getDataList();
