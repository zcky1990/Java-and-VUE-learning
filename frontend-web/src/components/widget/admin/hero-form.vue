...
<v-container>
    <div class="table-content">
        ...
        <v-data-table :headers="tableHeaderList" :items="dataTableList" :items-per-page="10" hide-default-footer class="elevation-1" :search="search">
            ...
            <v-container>
                <div ref="formContainer" class="form-container">
                    ...
                    <v-form ref="form" v-model="valid" width="300">
                        ...
                        <v-img :src="data.url_image" :lazy-src="defaultImage" aspect-ratio="1" max-width="500" max-height="300" cover class="grey lighten-2">
                        ...
                        <v-text-field v-model="data.title" label="Title" required outline flat color="rgb(0, 209, 178)"></v-text-field>
                        <v-text-field v-model="data.subtitle" label="Subtitle" required outline flat color="rgb(0, 209, 178)"></v-text-field>
