<template>
  <v-container>
        ...
        <div class="date-container">
          ...
          >
            ...
            <v-date-picker v-model="filter.startDate" no-title scrollable>
              ...
              <v-btn text color="primary" @click="$refs.startDate.save(filter.startDate)">OK</v-btn>
            </v-date-picker>
          </v-menu>
          <v-menu
            ref="endDate"
          ...
          >
            ...
            <v-date-picker v-model="filter.endDate" no-title scrollable>
              ...
              <v-btn text color="primary" @click="$refs.endDate.save(filter.endDate)">OK</v-btn>
            </v-date-picker>
          </v-menu>
        </div>
    ...
    <div class="title">Table Calon Mahasiswa</div>
    <v-simple-table>
...
export default {
  ...
  data() {
    return {
      ...
      urlData: {
        ...
        getFilteredDataListByNameOrEmailUrl:
          "/mahasiswa/get_all_mahasiswa_list_filtered_by_name_email",
  ...
  methods: {
    ...
    download: function() {
      if (this.filter.startDate != "" && this.filter.endDate != null) {
        let headersData = this.getRequestHeader();
        axios({
          url:
            this.urlData.download +
            "?startDate=" +
    ...
    getFilteredDataList: function() {
      ...
      let headers = this.getRequestHeader();
      this.get(
        this.urlData.getFilteredListUrl +
          "?page=" +
          this.page +
          "&startDate=" +
          this.filter.startDate +
    ...
    getFilteredDataListByNameOrEmail: function() {
      ...
      let headers = this.getRequestHeader();
      this.get(
        this.urlData.getFilteredDataListByNameOrEmailUrl +
          "?page=" +
          this.page +
          "&name=" +
          this.filter.name,
