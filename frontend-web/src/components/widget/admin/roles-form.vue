            ...
            <v-container>
                <div ref="formContainer" class="form-container">
                    ...
                    <v-form ref="form" v-model="valid" width="300">
                        ...
                        <v-text-field v-model="data.type" :rules="roleTypeRules" label="Type" required outline flat color="rgb(0, 209, 178)"></v-text-field>
                        <v-text-field v-model="data.name" :rules="roleNameRules" label="Name" required outline flat color="rgb(0, 209, 178)"></v-text-field>
                        <v-select :items="dataDropdownList" v-model="data.access_level" label="Access Level" outlined item-text="level" return-object color="rgb(0, 209, 178)"></v-select>
