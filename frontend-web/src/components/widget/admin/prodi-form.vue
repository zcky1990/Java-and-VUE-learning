            ...
            <v-container>
                <v-form ref="form" v-model="valid" width="300">
                    ...
                    <div class="domain-container">
                        <v-text-field v-model="data.prodiName" :rules="roleDomainRules" label="Add your Prodi Name" required outline flat color="rgb(0, 209, 178)"></v-text-field>
                    </div>
                    <v-select :items="facultyList" v-model="data.fakultas" label="Fakultas" required item-text="facultyName" return-object color="rgb(0, 209, 178)"></v-select>
