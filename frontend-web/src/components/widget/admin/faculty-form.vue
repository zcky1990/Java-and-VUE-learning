            ...
            <v-container>
                <v-form ref="form" v-model="valid" width="300">
                    ...
                    <div class="domain-container">
                        <v-text-field v-model="data.facultyName" :rules="roleDomainRules" label="Add your Faculty Name, ex: sejarah" required outline flat color="rgb(0, 209, 178)"></v-text-field>
                    </div>
