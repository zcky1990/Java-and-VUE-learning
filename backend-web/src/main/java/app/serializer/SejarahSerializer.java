...
public class SejarahSerializer implements JsonSerializer<Sejarah> {
	
	@Override
	public JsonElement serialize(Sejarah src, Type typeOfSrc, JsonSerializationContext context) {
